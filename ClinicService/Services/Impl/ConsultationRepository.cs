...
namespace ClinicService.Services.Impl
{
    ...
    public class ConsultationRepository : IConsultationRepository
    {
        ...
        public int Create(Consultation item)
        {
            ...
            command.CommandText = "INSERT INTO Consultations(ClientId, PetId, ConsultationDate, Description) VALUES(@ClientId, @PetId, @FirstName, @ConsultationDate, @Description)";
